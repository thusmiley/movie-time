...
const Search = ({ category, dataToSearch, setDataToSearch }) => {
  const [searchTitle, setSearchTitle] = useState(null);
  const handleSubmit = (e) => {
    e.preventDefault();
    setSearchTitle(e.target.search.value.toLowerCase());
  };

  // useEffect(() => {
  //   setDataToSearch(dataToSearch.filter((movie) => movie.title.toLowerCase() === searchTitle));
  // }, [searchTitle]);
